...
class FillPermissionsForBodegaTbl extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBodegaTbl constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.bodega-tbl',
            'admin.bodega-tbl.index',
            'admin.bodega-tbl.create',
            'admin.bodega-tbl.show',
            'admin.bodega-tbl.edit',
            'admin.bodega-tbl.delete',
            'admin.bodega-tbl.bulk-delete',
        ]);
