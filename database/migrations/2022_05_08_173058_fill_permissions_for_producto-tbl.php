...
class FillPermissionsForProductoTbl extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProductoTbl constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.producto-tbl',
            'admin.producto-tbl.index',
            'admin.producto-tbl.create',
            'admin.producto-tbl.show',
            'admin.producto-tbl.edit',
            'admin.producto-tbl.delete',
            'admin.producto-tbl.bulk-delete',
        ]);
