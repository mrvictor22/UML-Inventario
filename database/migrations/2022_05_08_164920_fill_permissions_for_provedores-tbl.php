...
class FillPermissionsForProvedoresTbl extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProvedoresTbl constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.provedores-tbl',
            'admin.provedores-tbl.index',
            'admin.provedores-tbl.create',
            'admin.provedores-tbl.show',
            'admin.provedores-tbl.edit',
            'admin.provedores-tbl.delete',
            'admin.provedores-tbl.bulk-delete',
        ]);
