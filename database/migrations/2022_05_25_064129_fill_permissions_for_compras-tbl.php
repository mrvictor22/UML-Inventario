...
class FillPermissionsForComprasTbl extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForComprasTbl constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.compras-tbl',
            'admin.compras-tbl.index',
            'admin.compras-tbl.create',
            'admin.compras-tbl.show',
            'admin.compras-tbl.edit',
            'admin.compras-tbl.delete',
            'admin.compras-tbl.bulk-delete',
        ]);
