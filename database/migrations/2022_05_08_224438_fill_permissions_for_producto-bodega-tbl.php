...
class FillPermissionsForProductoBodegaTbl extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProductoBodegaTbl constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.producto-bodega-tbl',
            'admin.producto-bodega-tbl.index',
            'admin.producto-bodega-tbl.create',
            'admin.producto-bodega-tbl.show',
            'admin.producto-bodega-tbl.edit',
            'admin.producto-bodega-tbl.delete',
            'admin.producto-bodega-tbl.bulk-delete',
        ]);
